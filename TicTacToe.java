...
public class TicTacToe
{
	...
	public static void main (String args[]){
		...
		int counter = 0, counter1 = 0; //checks whether game is at beginning or not //checks how many times you've placed a piece in an invalid place
							...
							while(inputInvalid == true){
								...
								if(inputInvalid == false){
									...
									if(counter1>2){
										...
										sleep(500);
										typedString(25, "Remember you can always type 'help' if you don't know what to do.");
										sleep(500);
